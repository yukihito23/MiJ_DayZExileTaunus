...
_cantBuildNear = [
    //Military
			"Land_Mil_Barracks_i","Land_Mil_House","Land_TentHangar_V1_F","Land_Ss_hangar","Land_Mil_ControlTower_EP1","Land_Garaz_bez_tanku","Land_i_Barracks_V1_F","Land_i_Barracks_V2_F","Land_u_Barracks_V2_F","Land_Cargo_House_V1_F","Land_Cargo_House_V3_F","Land_Cargo_HQ_V1_F","Land_Cargo_HQ_V2_F","Land_Cargo_HQ_V3_F","Land_Cargo_Patrol_V1_F","Land_Cargo_Patrol_V3_F","Land_Cargo_Tower_V1_F","Land_Cargo_Tower_V1_No1_F","Land_Cargo_Tower_V1_No2_F","Land_Cargo_Tower_V1_No3_F","Land_Cargo_Tower_V1_No4_F","Land_Cargo_Tower_V1_No5_F","Land_Cargo_Tower_V1_No6_F","Land_Cargo_Tower_V1_No7_F","Land_Cargo_Tower_V3_F","Land_Medevac_house_V1_F","Land_Medevac_HQ_V1_F","Land_MilOffices_V1_F","Land_Dome_Small_F","Land_Research_house_V1_F","Land_Research_HQ_F","Land_Hospital_side2_F","Land_Hospital_main_F","Land_Hospital_side1_F","Land_Ind_SiloVelke_01","Land_Ind_Mlyn_01","Land_Offices_01_V1_F"
                ];
_cantBuildDist = 400;
...
if( isClass(configFile >> "CfgMagazines" >> _itemClassName >> "Interactions" >> "Constructing") ) then
{
 ...
 try
 {
	...
	if (_cnt > 0 ) then
	{
	throw "You are too close to a town or city.";
	};
  ...
  if ([player, _minimumDistanceToSpawnZones] call ExileClient_util_world_isSpawnZoneInRange) then
  {
   throw "You are too close to a spawn zone.";
        ...
        {
         throw "You cannot build near military or airport buildings!";
        };
